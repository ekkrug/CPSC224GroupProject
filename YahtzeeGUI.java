...
public class YahtzeeGUI extends JFrame{
	...
	public void addMainMenuPanel()
	{
	    ...
	    // Play button
	    createGenBtn play = new createGenBtn("Play", 305, 500, mainMenuPanel);
	    play.setup();
	    
		// Leaderboard button
	    createGenBtn leaderboard = new createGenBtn("Leaderboard", 445, 500, mainMenuPanel);
	    leaderboard.setup();
	    
	    // Instructions button
	    createGenBtn instructions = new createGenBtn("Instructions", 725, 500, mainMenuPanel);
		instructions.setup(); 
	...
	public class createGenBtn implements ActionListener{
		...
		JPanel panelAdd;
		JButton btn;
		public createGenBtn(String Name, int Width, int Height, JPanel Add){
			btnName = Name;
			btnWidth = Width;
			btnHeight = Height;
			panelAdd = Add;
		...
		public void actionPerformed(ActionEvent e) {
			if(e.getSource() == btn) {
	    		...
	    		else if(btnName.equals("Leaderboard")) {
	...
	public void addInstrPnl1()
	{
	   ...
	   // Instructions title
		...
		// Next button
	    createGenBtn next1 = new createGenBtn("Next", 560, 500, instrPnl1);
	    
	    // Main Menu button
	    createGenBtn mainMenu1 = new createGenBtn("Main Menu", 725, 500, instrPnl1);
	...
	public void addInstrPnl2()
	{
	 ...
	 // ....
		...
		// Next button
	    createGenBtn next2 = new createGenBtn("Next", 560, 500, instrPnl2);
	    
	    // Main Menu button
	    createGenBtn mainMenu2 = new createGenBtn("Main Menu", 725, 500, instrPnl2);
